...
CREATE DATABASE IF NOT EXISTS `pokemon33` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pokemon33`;
...
CREATE TABLE IF NOT EXISTS `compras` (
  ...
  `estado` enum('A','I') CHARACTER SET utf8 NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `genero` enum('M','F') CHARACTER SET utf8 DEFAULT NULL,
